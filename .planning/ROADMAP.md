...
- [ ] **Phase 1: 应用脚手架与 Shell 命令核心** - 技术栈搭建、深色主题框架、文件夹选择、终端命令执行
- [ ] **Phase 2: 项目侧边栏与持久化** - 侧边栏项目管理、选中交互、数据持久化
...
Plans:
- [ ] 02-01: 侧边栏组件开发与项目列表渲染
- [ ] 02-02: 项目选中交互与删除功能
- [ ] 02-03: tauri-plugin-store 数据持久化集成
...
Plans:
- [ ] 03-01: 指令卡片组件与圆角矩形网格布局
- [ ] 03-02: 全局默认指令数据结构与渲染
- [ ] 03-03: 卡片点击执行与未选中禁用状态
- [ ] 03-04: 交互微动效（hover/active/selected 动画）
