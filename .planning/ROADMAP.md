...
Plans:
- [x] 06-01-PLAN.md — 使用 raw_arg 修复命令执行传参，含人工验证 checkpoint
...
Plans:
- [ ] 07-01-PLAN.md — TitleBar 组件 TDD 开发 + Tauri 无边框配置 + 根布局集成 + 人工视觉验证
...
| 7. 无边框窗口与自定义标题栏 | v1.1 | 0/1 | Planned | - |
| 8. Rust 后端扩展与快速 UI 修复 | v1.1 | 0/? | Not started | - |
