...
- [ ] **FLOAT-01**: User can open a mini floating window from main window toolbar or tray menu
- [ ] **FLOAT-02**: Floating window displays command buttons for the currently selected project
- [ ] **FLOAT-03**: Floating window stays always on top of other windows
- [ ] **FLOAT-04**: Floating window does not appear in the Windows taskbar
- [ ] **FLOAT-05**: Clicking a command in the floating window executes it on the currently selected project in the system terminal
- [ ] **FLOAT-06**: Floating window reflects project selection changes from main window in real-time
- [ ] **FLOAT-07**: User can close the floating window independently without affecting the main window

### Edge Drawer (DRAWER)

- [ ] **DRAWER-01**: User can drag the main window to any screen edge to trigger snap-and-hide
- [ ] **DRAWER-02**: All four screen edges (top, bottom, left, right) are supported for snapping
- [ ] **DRAWER-03**: When snapped and hidden, mouse contact at the hidden edge triggers the window to slide out
- [ ] **DRAWER-04**: Mouse leaving the revealed window causes it to slide back and auto-hide
- [ ] **DRAWER-05**: Slide-out and slide-back animations are smooth (no visual tearing or jumps)
- [ ] **DRAWER-06**: User can un-dock the window by dragging it away from the edge
